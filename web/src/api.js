...
export const api = {
  ...
  setBreakoutConfig: (patch) =>
    request('/api/config/breakout', { method: 'POST', body: JSON.stringify(patch) }),
  setColors: (patch) =>
  ...
  setZones: (patch) =>
    request('/api/config/zones', { method: 'POST', body: JSON.stringify(patch) }),
